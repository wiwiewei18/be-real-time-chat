...
import { ChatWSListener as ChatWSListenerV2 } from "../../modules/chat/v2/listeners/chat.ws.listener";
...
export class WebSocket {
  ...
  private chatWSListenerV2: ChatWSListenerV2;
  ...
  constructor(server: HttpServer, port: number) {
    ...
    this.chatWSListenerV2 = ChatModuleV2.buildListener();
    this.setupListeners();
  ...
  private setupListeners() {
    ...
    v2Namespace.on("connection", (webSocket) => {
      ...
      this.chatWSListenerV2.initializeListeners(webSocket, v2Namespace);
    });
  }
}
